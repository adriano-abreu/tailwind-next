...
function InputControl(props: InputControlProps) {
  return (
    <input
      className="flex-1 bg-transparent p-0 text-zinc-900 outline-none dark:text-zinc-100 dark:placeholder-zinc-400"
      {...props}
    />
  )
}
...
function InputRoot(props: InputRootProps) {
  return (
    <div
      className={twMerge(
        'group mx-1 flex w-full items-center gap-2 rounded-lg border border-zinc-300 px-3 py-2 shadow-sm',
